...
const situations=[
 ...
 ['ace','Your friend did very well on a difficult test.','You’re going to _____ the next one too.',['ace','lag'],'Do very well on a test.','Емтиханды өте жақсы тапсыру.'],
 ['chill','Your exams are over and you want a quiet evening.','Let’s _____ at home for a while.',['chill','cram'],'Relax.','Демалу.']
];
const norm=s=>String(s).trim().toLowerCase();
const key='slangify.daily-phrase.v2';
...
function setup(){
 ...
 function render(){
  ...
  const tag=document.createElement('span');tag.textContent='ONE CLEAR ANSWER · 1 MIN';top.append(heading,tag);
